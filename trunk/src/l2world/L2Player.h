...
public:
	...
	unsigned int paperdoll_iid[32]; ///< array of paperdoll itemIDs. Really there are 30 slots, but it's for align ^^
	unsigned int paperdoll_augid[32]; ///< array of paperdoll augmentationIDs. Really there are 30 slots, but it's for align ^^
	int isFakeDeath;
	int isFishing;
	int fishX;
	int fishY;
